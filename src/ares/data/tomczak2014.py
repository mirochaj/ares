...
redshifts = [0.35, 0.625, 0.875, 1.125, 1.375, 1.75, 2.25, 2.75]

units = {'phi': 'log10(phi)', 'mass': 'mass'}
...
tmp_data['smf_tot'] = \
{
 0.35: {'mass': list(10**np.arange(8.00, 11.50, 0.25)),
 ...
 0.625: {'mass': list(10**np.arange(8.25, 11.50, 0.25)),
 ...
 0.875: {'mass': list(10**np.arange(8.50, 11.50, 0.25)),
 ...
 1.125: {'mass': list(10**np.arange(8.75, 11.50, 0.25)),
 ...
 1.375: {'mass': list(10**np.arange(8.75, 11.75, 0.25)),
     'phi': [-2.02, -2.14, -2.28, -2.46, -2.53, -2.61, -2.68, -2.71, -2.84, -3.12, -3.65, -4.99],
     'err': [(0.06, 0.07), (0.06, 0.07), (0.06, 0.07), (0.07, 0.08),
             (0.07, 0.08), (0.08, 0.09), (0.08, 0.09), (0.08, 0.09),
             (0.08, 0.10), (0.10, 0.13), (0.12, 0.16), (0.30, 0.41)],
    },
 1.75: {'mass': list(10**np.arange(9.00, 11.75, 0.25)),
...
tmp_data['smf_sf'] = \
{
 ...
 1.375: {'mass': list(10**np.arange(8.75, 11.75, 0.25)),
     'phi': [-2.03, -2.15, -2.29, -2.48, -2.55, -2.68, -2.75, -2.87, -3.07, -3.39, -3.95, -5.17],
     'err': [(0.06, 0.07), (0.06, 0.07), (0.06, 0.07), (0.07, 0.08),
             (0.07, 0.08), (0.08, 0.09), (0.08, 0.10), (0.08, 0.09),
             (0.08, 0.10), (0.10, 0.13), (0.13, 0.17), (0.37, 0.52)],
    },
 1.75: {'mass': list(10**np.arange(9.00, 11.75, 0.25)),
...
tmp_data['smf_q'] = \
{
 0.35: {'mass': list(10**np.arange(8.25, 11.5, 0.25)),
     'phi': [-2.41, -2.62, -2.82, -2.96, -2.96, -2.98, -2.91, -2.86,
             -2.78, -2.80, -2.76, -3.07, -3.52],
     'err': [(0.08, 0.10), (0.10, 0.11), (0.12, 0.14), (0.14, 0.16),
             (0.08, 0.10), (0.09, 0.10), (0.09, 0.11), (0.09, 0.11),
             (0.08, 0.10), (0.09, 0.11), (0.09, 0.12), (0.12, 0.16),
             (0.14, 0.19)]
     },
  0.625: {'mass': list(10**np.arange(8.5, 11.50, 0.25)),
     'phi': [-2.42, -2.58, -2.77, -2.75, -2.94, -2.99, -2.83, -2.78,
             -2.75, -2.75, -2.93, -3.37],
     'err': [(0.07, 0.08), (0.07, 0.08), (0.09, 0.10), (0.09, 0.10),
             (0.10, 0.11), (0.07, 0.08), (0.07, 0.08), (0.07, 0.09),
             (0.08, 0.09), (0.08, 0.10), (0.09, 0.11),
             (0.11, 0.14)],
    },
  0.875: {'mass': list(10**np.arange(9, 11.50, 0.25)),
 ...
 1.125: {'mass': list(10**np.arange(9, 11.50, 0.25)),
 ...
 1.375: {'mass': list(10**np.arange(9.25, 11.75, 0.25)),
     'phi': [-3.97, -3.79, -3.75, -3.45, -3.52, -3.24, -3.23, -3.46, -3.95, -5.47],
     'err': [(0.21, 0.24), (0.17, 0.19), (0.16, 0.18), (0.12, 0.14),
             (0.13, 0.15), (0.08, 0.10), (0.09, 0.11), (0.10, 0.13),
             (0.13, 0.17), (0.52, 0.90)],
    },
 1.75: {'mass': list(10**np.arange(9.50, 11.75, 0.25)),
 ...
 2.25: {'mass': list(10**np.arange(9.75, 11.75, 0.25)),
 ...
 2.75: {'mass': list(10**np.arange(9.75, 11.75, 0.25)),
