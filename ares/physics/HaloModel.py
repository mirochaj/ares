...
class HaloModel(HaloMassFunction):
    ...
    def _get_ps_integrals(self, k, iz, prof1, prof2, lum1, lum2, mmin1, mmin2,
        focc1, focc2, bias2, term, mmax1=np.inf, mmax2=np.inf, weight_by_mass=True):
        """
        ...
        if type(k) == np.ndarray:
            ...
            for _k in k:
                _integ1, _integ2 = self._integrate_over_prof(_k, iz,
                    prof1, prof2, lum1, lum2, mmin1, mmin2, focc1, focc2, bias2, term,
    ...
    def _integrate_over_prof(self, k, iz, prof1, prof2, lum1, lum2, mmin1,
        mmin2, focc1, focc2, bias2, term, mmax1, mmax2, weight_by_mass=True):
        """
        Compute integrals over profile, weighted by bias, dndm, etc.,
        needed for halo model.
        """
        ...
        if term == 1:
            ...
            integral1 = np.trapz(integrand1[ok*ok1==1], x=np.log(self.tab_M[ok*ok1==1]),
                axis=0)
    ...
    def get_ps_2h(self, z, k=None, prof1=None, prof2=None, lum1=None, lum2=None,
        mmin1=None, mmin2=None, mmax1=np.inf, mmax2=np.inf, focc1=1, focc2=1, bias2=None,
        ztol=1e-3, weight_by_mass=True):
        """
        ...
        integ1, integ2 = self._get_ps_integrals(k, iz, prof1, prof2,
            lum1, lum2, mmin1, mmin2, focc1, focc2, bias2, 2, mmax1, mmax2,
