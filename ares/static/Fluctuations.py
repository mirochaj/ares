...
class Fluctuations(object):
    ...
    def overlap_volumes(self, dr, R1, R2):
        ...
        V2n = V2 - (IV(dr, R2, R2) - IV(dr, R1, R2))
    ...
    def BubbleShellFillingFactor(self, z, zeta, R_s):
        ...
        if self.pf['bubble_size_dist'] is None:
            ...
            #
            #Qi = np.trapz(dndlnm[iM:] * V_i[iM:], x=np.log(M_b[iM:]))
    ...
    def BubbleFillingFactor(self, z, zeta, rescale=True):
        ...
        if self.bsd_model is None:
            ...
            R_i, M_b, dndm_b = self.BubbleSizeDistribution(z, zeta, rescale)
            V_i = 4. * np.pi * R_i**3 / 3.
   ...
   #    return simps(B[iM:] * dndm_b[iM:] * M_b[iM:], x=np.log(M_b[iM:]))
    ...
    def ExpectationValue1pt(self, z, zeta, term='i', R_s=None, R3=None, 
        ...
        if term == 'i':
            ...
            if self.pf['ps_include_xcorr_hot_rho']: 
                ...
                del_i = self.delta_bubble_vol_weighted(z, zeta)
                val = Qh * ch * del_i * self.pf['bubble_shell_rdens_zone_0'] \
                    + (1. - Qh - Qi) * (Tcmb / Ts)
            else:
                val = 0.0
        elif term == 'c*d':
            ...
            avg_id = self.ExpectationValue1pt(z, zeta, term='i*d',
                R_s=R_s, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            avg_i = self.ExpectationValue1pt(z, zeta, term='i',
                R_s=R_s, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
            ...
            avg_psi = self.ExpectationValue1pt(z, zeta, term='psi',
                R_s=R_s, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            avg_psi_c = self.ExpectationValue1pt(z, zeta, term='pc',
                R_s=R_s, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
    ...
    def ExpectationValue2pt(self, z, zeta, R, term='ii', R_s=None, R3=None, 
        ...
        # else can happen.
        Qh = self.BubbleShellFillingFactor(z, zeta, R_s=R_s)
        ...
        if term == 'psi':
            ...
            print('HELLO: from psi')
            
            # All in terms of ionized fraction perturbation.
            dd, dd1, dd2 = self.ExpectationValue2pt(z, zeta, R=R, term='dd',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            ii, ii1, ii2 = self.ExpectationValue2pt(z, zeta, R=R, term='ii',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            di, di1, di2 = self.ExpectationValue2pt(z, zeta, R=R, term='id',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            iidd, on, tw = self.ExpectationValue2pt(z, zeta, R=R, term='iidd',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja) 
            idd, on, tw = self.ExpectationValue2pt(z, zeta, R=R, term='idd',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            iid, on, tw = self.ExpectationValue2pt(z, zeta, R=R, term='iid',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)       
            ...
            ev_oo, ev_oo1, ev_oo2 = self.ExpectationValue2pt(z, zeta, R,
            ...
            ppc, _p1, _p2 = self.ExpectationValue2pt(z, zeta, R=R, term='ppc',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
            ppcc, _p1, _p2 = self.ExpectationValue2pt(z, zeta, R=R, term='ppcc',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
        ...
        # <psi psi' c> = <cdd'> - 2 <cdi'> - 2 <ci'dd>
            ...
            cdd, _j1, _j2 = self.ExpectationValue2pt(z, zeta, R=R, term='cdd',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja) 
            cdip, _j1, _j2 = self.ExpectationValue2pt(z, zeta, R=R, term='cdip',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja) 
            cddip, _j1, _j2 = self.ExpectationValue2pt(z, zeta, R=R, term='cddip',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)        
            
            ppc = cdd - 2 * cdip - cddip
            
            return ppc, Rzeros, Rzeros
            
        elif term == 'ppcc':
            ccdd, _j1, _j2 = self.ExpectationValue2pt(z, zeta, R=R, term='ccdd',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
                
            return ccdd, Rzeros, Rzeros    
            ...
            if self.pf['ps_include_xcorr_hot_rho']:
                ...
                # 'd' here is unprimed
                ev_xxcd, ev_xxcd1, ev_xxcd2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='xxcd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k)
                # 'd' here is primed, i.e., NOT associated with contrast pt.
                ev_xxcdp, ev_xxcdp1, ev_xxcdp2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='xxcdp',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k) 
                ev_xxcdd, ev_xxcdd1, ev_xxcdd2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='xxcdd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k)      
                ev_xxccd, ev_xxccd1, ev_xxccd2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='xxccd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k) 
                ev_xxccdd, ev_xxccdd1, ev_xxccdd2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='xxccdd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k)        
                
                Phi += 2. * (ev_xxcd + ev_xxcdp + ev_xxcdd) \
                     + 2 * ev_xxccd + ev_xxccdd
            ...
            if self.pf['ps_include_temp']:
                ...
                result += ev_hh * ch**2 + ev_ii * ci**2 + ev_ih * ch * ci
            ...
            return ev_ih * ch + ev_ii * ci, Rzeros, Rzeros
            ...
            ev_ic, ev_ic1, ev_ic2 = \
                ...
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            ev_ii, ev_ii1, ev_ii2 = self.ExpectationValue2pt(z, zeta, R=R, term='ii',
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
                
            return avg_c - avg_ic - ev_ic + ev_ii * ci, Rzeros, Rzeros
        
        elif term == 'xxcc':
            if not self.pf['ps_include_4pt']:
                return Rzeros, Rzeros, Rzeros
            
            # <xx'cc'> = <cc'(1 - x_i - x_i' + x_i x_i')>    
            #          = <cc'> - 2 <x_i c c'> + <cc'x_i x_i'>
            ...
            ev_icc, ev_icc1, ev_icc2 = self.ExpectationValue2pt(z, zeta, R, 
                term='icc', R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja, k=k)
            
            ci = self.BubbleContrast(z, Th=Th, Tk=Tk, Ts=Ts, Ja=Ja)  
                    
            xxcc = cc - 2 * ev_icc + ev_ii * ci**2
        ...
        ####
            ...
            ev_ccdd, ev_ccdd1, ev_ccdd2 = \
                self.ExpectationValue2pt(z, zeta, R, term='ccdd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            
            return ev_ccdd, ev_ccdd1, ev_ccdd2
        elif term == 'xxccd':
            # Only one term survives
            ev_ccd, ev_ccd1, ev_ccd2 = \
                self.ExpectationValue2pt(z, zeta, R, term='ccd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            
            return ev_ccd, ev_ccd1, ev_ccd2
        elif term == 'xxcdd':
            ...
            # Just assume this is zero for now        
            ev_cddip, ev_cddip1, ev_cddip2 = \
                self.ExpectationValue2pt(z, zeta, R, term='cddip',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)        
            
            return ev_ccd - ev_cddip, Rzeros, Rzeros
        elif term == 'xxcdp':
            # Only one term survives
            ev_cd, ev_cd1, ev_cd2 = \
                self.ExpectationValue2pt(z, zeta, R, term='cd',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            ev_cdpip, ev_cdpip1, ev_cdpip2 = \
                self.ExpectationValue2pt(z, zeta, R, term='cdpip',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)        
            
            return ev_cd - ev_cdpip, Rzeros, Rzeros
        elif term == 'xxcd':
            avg_cd = self.ExpectationValue1pt(z, zeta, term='c*d',
                R_s=R_s, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
                
            # Only one term survives
            ev_cdip, ev_ccd1, ev_ccd2 = \
                self.ExpectationValue2pt(z, zeta, R, term='cdip',
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            
            return avg_cd - ev_cdip, ev_ccd1, ev_ccd2
        ...
        # <c d d' x_i'>
            ...
            # Need a large-scale correction here...
            ev_cddip = c * delta_h_bar * Pih
        
            return ev_cddip, Rzeros, Rzeros    
        ...
        # Correct this when temperature fluctuations on?
        delta_b_bar = self.BulkDensity(z, zeta, R_s)
        delta_s_bar = delta_i_bar * self.pf['bubble_shell_rdens_zone_0']
                
        Tcmb = self.cosm.TCMB(z)
        near_c = self.TempToContrast(z, Th=Th, Tk=Tk, Ts=Ts, Ja=Ja)
        bulk_c = Tcmb / Ts
        ...
        # Handy
        ##
        if self.pf['ps_include_ion'] and (term not in ['ii', 'ib']):
            _P_ii, _P_ii_1, _P_ii_2 = \
                self.ExpectationValue2pt(z, zeta, R, term='ii', 
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            _P_ib, _P_ib_1, _P_ib_2 = \
                self.ExpectationValue2pt(z, zeta, R, term='ib', 
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
        
        if self.pf['ps_include_temp'] and (term != 'hh') and term.count('i') == 0:
            _P_hh, _P_hh_1, _P_hh_2 = \
                self.ExpectationValue2pt(z, zeta, R, term='hh', 
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)
            if term != 'hb':
                _P_hb, _P_hb_1, _P_hb_2 = \
                    self.ExpectationValue2pt(z, zeta, R, term='hb', 
                    R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)    
        
        if self.pf['ps_include_temp'] and self.pf['ps_include_xcorr_ion_hot'] \
            and (term != 'ih') and term.count('i') == 0:
            _P_ih, _P_ih_1, _P_ih_2 = \
                self.ExpectationValue2pt(z, zeta, R, term='ih', 
                R_s=R_s, R3=R3, Th=Th, Ts=Ts, Tk=Tk, Ja=Ja)        
                
        if term in ['hh', 'ih']:
            V = 4. * np.pi * (R_s**3 - R_i**3) / 3.
            Qh_int = self.get_prob(z, M_b, dndm_b, Mmin, V, 
                exp=False, ep=0.0, Mmax=None)
            f = -np.log(1. - Qh) / Qh_int
        else:
            f = 1.
        ...
        for i, sep in enumerate(R):
            ...
            # Probability that one point is ionized, other in "bulk IGM"
                ...
                _P2_iN = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_iN, True)
                _P2_iN2 = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_iN, True, ep)
                
                P2[i] = _P2_iN * (1. - _P2_iN2)
                ...
                Vo_AN = all_V[5] # region in which a source does anything to
                                 # one point and does nothing to the other.
                
                
                # Must take care that if temperature fluctuations are on
                # that the second point isn't in the heated shells around bubbles.    
                    
                # Just grab this because we need to know that points
                # aren't in the same bubble.

                _P2_hN = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_hN, True)
                _P2_hN2 = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_hN, True, ep)
                _P2_iN2 = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_iN, True, ep)
                _P2_AN2 = self.get_prob(z, M_b, dndm_b, Mmin_b, Vo_AN, True, ep)
                
                # Why doesn't a (1 - _P2_AN2) term yield the same result?
                _P2 = _P2_hN * (1. - _P2_iN2 - _P2_hN2)
                #(Qi - _P1_ii - _P1_ih) * _P2_1 * (1. - _P2_ii - _P2_ih)
                ...
                _P1 = self.get_prob(z, M_b, dndm_b * f, Mmin_b, Vo, True)                
                
                _P2_1 = self.get_prob(z, M_b, dndm_b * f, Mmin_b, Vne1, True)
                _P2_2 = self.get_prob(z, M_b, dndm_b * f, Mmin_b, Vne2, True, ep)
            ...
            if term == 'id':                    
                ...
                # Assume medium with two densities.
                    ...
                    P2[i] = _P_ii[i] * delta_i_bar + _P_ib[i] * delta_b_bar
                ...
                if self.pf['ps_include_xcorr_ion_rho'] == 1:
                    ...
                    _P21 = _P_ii_1[i] + _P_ii_2[i]
                    _P22 = _P_ib[i]
                    P2[i] = (_P21 * delta_i_bar + _P22 * delta_b_bar) * delta_i_bar
                ...
                if not self.pf['ps_include_xcorr_hot_rho']:
                    break
                if self.pf['ps_include_xcorr_hot_rho'] == 1:
                    raise NotImplemented('help')
                    hal = np.trapz(dndm_h * V_h * (1. + exc) * M_h,
                        x=np.log(M_h))
                    hot = np.trapz(dndm_b[iM:] * Vsh[iM:] * self.m[iM:], 
                    ...
                    ex_ih = _P_ih[i] * delta_i_bar * delta_s_bar
                    # One point ionized, other point in bulk IGM
                    ex_ib = _P_ib[i] * delta_i_bar * delta_b_bar
                    # One point in shell, other point in bulk IGM
                    ex_hb = _P_hb[i] * delta_s_bar * delta_b_bar
            
                    P2[i] = ex_ih + ex_ib + ex_hb
                else:
                    raise NotImplemented('help')
                ...
                if not self.pf['ps_include_xcorr_hot_rho']:
                    ...
                    P1[i] = _P_hh_1[i] * delta_i_bar**2 * delta_h_bar**2
                    P2[i] = _P_hh_2[i] * delta_i_bar**2 * delta_h_bar**2
                    continue
    ...
    def CorrelationFunction(self, z, zeta=None, R=None, term='ii', 
        ...
        if term in ['21', 'phi', 'psi']:
            ...
            if (include_temp or include_lya) and term in ['phi', '21']:
                ...
                ev_oo, o1, o2 = self.ExpectationValue2pt(z, zeta, R=R, 
                    term='oo', R_s=R_s, Ts=Ts, Tk=Tk, Th=Th, Ja=Ja, k=k)
                avg_oo = self.ExpectationValue1pt(z, zeta, term='oo', 
                    R_s=R_s, Ts=Ts, Tk=Tk, Th=Th, Ja=Ja, R3=R3)
                
                cf_omega = ev_oo - avg_oo
                    
                cf_21 = cf_psi + cf_omega
