...
class PowerLawEvolvingAsB13(BasePQ):
    def __call__(self, **kwargs):
        if self.x == "1+z":
            x = 1. + kwargs["z"]
        else:
...
class ErfXEvolvingAsB13(BasePQ):
    def __call__(self, **kwargs):
        if self.x == "1+z":
            x = 1. + kwargs["z"]
        else:
        ...
        # This is like ErfEvolvingAsB13 except the low-mass behaviour
...
class ParameterizedQuantity(object):
    def __init__(self, **kwargs):
        ...
        elif kwargs["pq_func"] == 'pl_evolB13':
            self.func = PowerLawEvolvingAsB13(**kwargs)
        ...
        elif kwargs["pq_func"] == "erfx_evolB13":
            self.func = ErfXEvolvingAsB13(**kwargs)
