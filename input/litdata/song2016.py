...
tmp_data['smf'] = \
{
 4: {'M': list(10**np.arange(7.25, 11.75, 0.5)),
     ...
     'err': [(0.21, 0.16), (0.15, 0.14), (0.13, 0.10), 0.09, 0.09, 
 ...
 5: {'M': list(10**np.arange(7.25, 11.75, 0.5)),
     ...
     'err': [(0.24, 0.21), 0.20, 0.16, (0.15, 0.10),
