...
def test():
    pars = ares.util.ParameterBundle('mirocha2025:setup').pars_by_pop(0,1)
    ...
    pars2 = ares.util.ParameterBundle('mirocha2025:setup').pars_by_pop(0,1)
    ...
    pars0 = ares.util.ParameterBundle('mirocha2025:setup').pars_by_pop(0,1)
