...
def test():
    ...
    fitter.run(prefix='test_tanh', burn=10, steps=10, save_freq=10, clobber=True)
    ...
    anl.skip = 10  
    shape_good = (anl.chain.shape[0]-10, anl.chain.shape[1])
    ...
    # Clean-up
    mcmc_files = glob.glob('{}/tests/test_tanh*'.format(os.environ.get('ARES')))
